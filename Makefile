...
OS = $(shell uname)
UID = $(shell id -u)
DOCKER_BE = api-proficiency-test-be
...
start: ## Start the containers
	docker network create api-proficiency-test-network || true
...
code-style: ## Runs php-cs to fix code styling following Symfony rules
	U_ID=${UID} docker exec --user ${UID} ${DOCKER_BE} tools/php-cs-fixer/vendor/bin/php-cs-fixer fix src --rules=@Symfony
